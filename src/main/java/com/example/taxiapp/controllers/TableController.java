...
public class TableController implements Initializable {
    ...
    public void cb() throws SQLException {
        for(int i = 0; i < databaseManager.tables().size(); i++ ){
            car.getItems().add(databaseManager.tables().get(i));
        }
...
//        try {
//            ObservableList<CarEntity> day = databaseManager.getCarDay(car.getValue());
//
...
//        try {
//            ObservableList<CarEntity> night = databaseManager.getCarNight(car.getValue());
//
//            colDate.setCellValueFactory(new PropertyValueFactory<CarEntity, String>("date"));
